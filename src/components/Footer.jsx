      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-white/20 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex space-x-6 justify-start md:justify-end">
            ...
            <Link to="#" className=" bg-red-500 text-white hover:bg-red-600 p-2 rounded-full  transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
              </svg>
            </Link>
            <Link to="#" className=" bg-pink-500 text-white hover:bg-pink-600 p-2 rounded-full  transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
