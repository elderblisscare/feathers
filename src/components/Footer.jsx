      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-white/20 grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
          ...
          <div className="flex space-x-6 justify-start lg:justify-end">
            <Link to="https://www.facebook.com/profile.php?id=61589468154957" target='_blank' className=" bg-blue-500 text-white hover:bg-blue-600 p-2 rounded-full  transition-colors">
            ...
            <Link to="https://www.instagram.com/feathers.agency29/" target='_blank' className=" bg-pink-500 text-white hover:bg-pink-600 p-2 rounded-full  transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
