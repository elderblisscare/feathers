    ...
    return (
        <>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 py-16 px-6 lg:px-20 bg-gray-50 min-h-screen items-stretch">
                ...
                <div
                    ref={infoRef}
                    className="bg-[#012d61] h-full  backdrop-blur-md rounded-xl p-5 lg:p-6 text-white shadow-xl border border-white/10 hover:border-white/20 transition-all"
                >
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex space-x-3">
                            ...
                            <a href="https://www.instagram.com/feathers.agency/" target='_blank' className="social-icon bg-white/10 hover:bg-gradient-to-br hover:from-[#1C4571] hover:to-[#2a5d94] p-2 rounded-full transition-all duration-300 transform hover:scale-110 hover:shadow-md">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
