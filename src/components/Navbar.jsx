...
//               <Link 
//                 to={`https://wa.me/${contactInfo.phone.replace(/[^0-9]/g, '')}?text=Hello%20I%20need%20help`}
//                 target="_blank"
        ...
        <div className="grid grid-cols-[auto_1fr_auto] items-center h-16">
          ...
          <div className="flex justify-end items-center gap-3 w-full">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex bg-green-500 text-white p-2 rounded-full hover:bg-green-600 transition"
            >
            ...
            <a
              ...
              className="hidden lg:flex flex items-center gap-2 bg-blue-500 text-white hover:bg-blue-600 p-2 rounded-full"
            >
